[assembly: Xamarin.Forms.ExportRenderer(
    typeof(Ventas.Views.LoginFacebookPage),
    typeof(Ventas.Droid.Implementations.LoginFacebookPageRenderer))]
...
namespace Ventas.Droid.Implementations
{
    ...
    public class LoginFacebookPageRenderer : PageRenderer
    {
        ...
        private async Task<TokenResponse> GetFacebookProfileAsync(string accessToken)
        {
            ...
            var prefix = Xamarin.Forms.Application.Current.Resources["Prefix"].ToString();
