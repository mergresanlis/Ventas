    ...
    public class ApiService
    {
        ...
        public async Task<TokenResponse> GetToken(string urlBase,string username,string password)
        {
            try
            {
                ...
                var url = new Uri(string.Format(urlBase + "/Token", string.Empty));
        ...
        public async Task<Response> GetList<T>(string urlBase, string prefix, string controller)
        {
            try
            {
                ...
                var client = new HttpClient();
                var url = new Uri(string.Format(urlBase + prefix + controller, string.Empty));
                //client.BaseAddress = new Uri(urlBase);
        ...
        public async Task<Response> GetList<T>(string urlBase, string prefix, string controller, int id, string tokenType, string accessToken)
        {
            try
            {
                ...
                var client = new HttpClient();
                var url = new Uri(string.Format(urlBase + prefix + controller + "/" + id, string.Empty));
                //client.BaseAddress = new Uri(urlBase);
                //var url = $"{prefix}{controller}";
                client.DefaultRequestHeaders.Authorization = new AuthenticationHeaderValue(tokenType, accessToken);
                var response = await client.GetAsync(url);
        ...
        public async Task<TokenResponse> LoginTwitter(string urlBase, string servicePrefix, string controller, TwitterResponse profile)
        {
            try
            {
                ...
                var content = new StringContent(
                    ...
                    "application/json");
                var client = new HttpClient();
                var url = new Uri(string.Format(urlBase + servicePrefix + controller, string.Empty));
                //client.BaseAddress = new Uri(urlBase);
